...
class CarStorageViewModel: ViewModel() {
    ...
    suspend fun refreshSlots(carID: ULong, token: String){
        val response: Response<Car> = client.get(BuildConfig.BACKEND_URL + "/admin/car/" + carID.toString()) {
