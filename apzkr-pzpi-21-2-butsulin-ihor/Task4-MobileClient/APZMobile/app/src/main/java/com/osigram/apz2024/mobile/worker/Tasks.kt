...
@Composable
fun TasksScreen(modifier: Modifier = Modifier, tasksViewModel: TasksViewModel = viewModel()){
    ...
    val onSetDoneClick: (ULong) -> Unit = {
        coroutineScope.launch {
            withContext(Dispatchers.IO){
                tasksViewModel.setDoneTask(it, token)
            }
        }
    }
        ...
        PullToRefreshBox(
            ...
            LazyColumn(
                ...
                items(
                    ...
                    TaskElement(it, onSetDoneClick, modifier = modifier)
                }
            }
        }
    }
...
@Composable
fun TaskElement(task: Task, onSetDone: (ULong) -> Unit, modifier: Modifier = Modifier){
    Column(
        modifier = modifier
    ){
        ListItem(
